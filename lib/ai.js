...
/**
 * Speech-to-Text using Groq Whisper (fast, accurate)
 * @param {Buffer} audioBuffer - Audio file buffer (ogg, mp3, wav, etc.)
 * @param {object} [options] - Optional: language, filename
