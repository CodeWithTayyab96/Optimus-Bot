...
EMOJI USAGE:
Use actual emojis like 😊 😂 😅 🙄 😉 🥺 😎 🤔 😴
DON'T write emoji names like "winks", "eye roll", "shrug"
...
${JSON.stringify(userContext.userInfo, null, 2)}`;
        ...
        const result = await chat(systemPrompt, userMessage, { maxTokens: 256, temperature: 1.0 });
